...
public class BaseEntity
{
    ...
    public static final EntityField CREATED_DATE_FIELD = new EntityField("BaseEntity.createdDate");
    public static final EntityField UPDATED_DATE_FIELD = new EntityField("BaseEntity.updatedDate");
